...
<jsp:setProperty name="bbs" property="you_tier" />
...
<body>
	...
	<%
	if (bbs.getnickname() == null || bbs.getpassword() == null || bbs.getme_tier() == null || bbs.getme_line() == null || bbs.getyou_tier() == null || bbs.getyou_line() == null || bbs.getcontent() == null) {
		...
		int result = duo_BbsDao.write(bbs.getnickname(), bbs.getpassword() , bbs.getme_tier(), bbs.getme_line(), bbs.getyou_tier(), bbs.getyou_line(), bbs.getcontent());
		if (result == -1) {
			PrintWriter script = response.getWriter();
			script.println("<script>");
