    ...
    <body>
        ...
        <div class="container">
      		<div class="row justify-content-around">
      			<form method="post" action="scream_writeAction.jsp">
      				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width: 600px;">
      					...
      					<tbody>
      						<tr>
      							<td><input type="text" class="form-control" placeholder="팀 이름" name="name" maxlength="50"/></td>
      						</tr>
                            <tr>
      							<td>TEAM AVG TIER
                              ...
                              <tr>
                                <td><input type="text" class="" placeholder="팀장 닉네임" name="leadername" maxlength="8"/><span style="font-size: 11px" id="getUserIp"><%=getClientIP(request)%></span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="password" class="" placeholder="비밀번호" name="password" maxlength="10"/></td>
