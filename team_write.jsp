    ...
    <body>
        ...
        <div class="container">
      		<div class="row justify-content-around">
      			<form method="post" action="team_writeAction.jsp">
      				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width: 600px;">
      					...
      					<tbody>
                            ...
                            <tr>
                                <td><input type="text" class="" placeholder="팀 이름" name="name" maxlength="16"/><span style="font-size: 11px" id="getUserIp"><%=getClientIP(request)%></span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="password" class="" placeholder="게시글 비밀번호" name="password" maxlength="10"/></td>
