...
<body>
	...
	<%
	if (bbs.getpassword() == null || bbs.getAVGtier() == null || bbs.getname() == null || bbs.getcontent() == null) {
		...
		int result = team_BbsDAO.write(bbs.getAVGtier(), bbs.getname(), bbs.gettop(), bbs.getjungle(), bbs.getmid(), bbs.getbot(), bbs.getsupport(), bbs.getcontent(), bbs.getpassword());
		if (result == -1) {
			PrintWriter script = response.getWriter();
			script.println("<script>");
